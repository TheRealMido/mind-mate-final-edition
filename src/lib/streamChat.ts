...
export async function streamChat({
  ...
  let prefs = session?.user?.user_metadata?.preferences;
  ...
  if (isSupabasePlaceholder) {
    console.info("Using mock chat response (Guest Mode)");
    ...
    const mockResponses = [
      ...
      "I'm here for you. Remember that your feelings are valid. Would you like to try a breathing exercise?",
      "That sounds like it's been challenging. I'm glad you reached out to me. What small thing could help you feel better right now?",
    ];
